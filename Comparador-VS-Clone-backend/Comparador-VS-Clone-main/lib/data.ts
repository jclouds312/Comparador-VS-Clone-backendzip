...
export const ALL_PRODUCTS: Product[] = [
  ...
  {
    id: "p1_p",
    name: "Báscula Ganadera Prometálicos",
    brand: "Prometálicos",
    category: "Básculas Ganaderas",
    categoryKey: "basculas_ganaderas",
    image: "https://images.unsplash.com/photo-1500595046743-cd271d694d30?w=800&h=600&fit=crop",
    ...
    specs: [
      ...
      { label: "Plataforma", value: "180x70 cm", numericValue: 12600, unit: "cm²", higherIsBetter: true },
      { label: "Material", value: "Acero al Carbón" },
      { label: "Display", value: "Indicador Estándar" },
      { label: "Conectividad", value: "RS232" },
      { label: "Garantía", value: "12 meses", numericValue: 12, unit: "meses", higherIsBetter: true },
    ],
  },
  {
    id: "p4",
    ...
    specs: [
      ...
      { label: "Garantía", value: "60 meses", numericValue: 60, unit: "meses", higherIsBetter: true },
    ],
  },
  {
    id: "p4_p",
    name: "Báscula Camionera Prometálicos",
    brand: "Prometálicos",
    category: "Básculas Camioneras",
    categoryKey: "basculas_camioneras",
    image: "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=800&h=600&fit=crop",
    ...
    specs: [
      ...
      { label: "Precisión", value: "50 kg", numericValue: 50, unit: "kg", higherIsBetter: false },
      { label: "Plataforma", value: "15x3 m", numericValue: 450000, unit: "cm²", higherIsBetter: true },
      { label: "Material", value: "Acero Estructural" },
      { label: "Display", value: "Indicador Básico" },
      { label: "Conectividad", value: "Serial" },
  ...
  {
    id: "p17",
    name: "Cuarto Frío Industrial 20m³",
    brand: "SOFTGAN",
    category: "Cuartos Fríos",
    categoryKey: "cuartos_frios",
    image: "https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=800&h=600&fit=crop",
